...
public class Login extends JFrame
{
	...
	public Login() 
	{	
		setTitle("123@quiz: Login "+Connect.success);
		...
		label2.setText("quiz management");
		...
		btnLogin.addActionListener(new ActionListener() 
				...
				if (username.equals("")|| password.equals(""))
				{
                   ...
                   {
					if(Connect.success.equals("database.Proceeding in Offline Mode"))
						login=true;
